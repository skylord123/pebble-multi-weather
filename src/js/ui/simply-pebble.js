...
var fontKeyMap = {
  ...
  'bitham-42-bold': 9,
  'bitham-42-light': 10,
  'bitham-42-medium-numbers': 11,
  'roboto-condensed-21': 12,
  'roboto-bold-subset-49': 13,
  'droid-serif-28-bold': 14
};

// Text overflow mode mapping
var overflowModeMap = {
  'wrap': 0,
  'ellipsis': 1,
  'fill': 2
...
SimplyPebble.calculateTextSize = function(text, font, width, overflow, alignment, callback) {
  ...
  // Get overflow mode
  var overflowMode = overflowModeMap[overflow] || 0;
